...
/*FUNCION PARA LEER EN BASE DE DATOS DEL CELULAR*/
		LeerInformacionTRAMPA: function(tx){
			...
			almacen.db.transaction(almacen.leerinformacionTRAMPA, almacen.error, null);
									...
									tx.executeSql("SELECT descripcion_planta,direccion_planta,descripcion_tipo_trampa,descripcion_control_trampa,ubicacion FROM trampas where upper(id_trampa) = upper('" +$('#txt_id_trampa').val()+ "')", [], function(tx2, t){
